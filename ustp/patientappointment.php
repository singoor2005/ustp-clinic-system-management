...
if(isset($_POST[submit]))
{
	...
	else
	{
		if(isset($_SESSION[patientid]))
		{
			echo "<h2>Appointment is already taken.. </h2>";
...
{
 ?>
   <form method="post" action="" name="frmpatapp" onSubmit="return validateform()" style="color:white; font-weight: bold;">
    <table width="532" border="3"
    style="background-image: 
    linear-gradient(rgba(0,0,0,0.40),rgba(0,0,0,0.40)),url(./images/3.png);"> 
    <!-- form background -->
      <tbody>
        <tr>
